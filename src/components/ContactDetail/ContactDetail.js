          ...
          <div className="contact-information">
            ...
            <div className="contact-info-wrapper">
              <div className="contact-info">
                <span className="icon"><img src={emailBlueIcon} alt="email" /></span>
                <a href="mailto:info@linumtech.com">info@linumtech.com</a>
              </div>

              <div className="contact-info">
                <span className="icon"><img src={phoneBlueIcon} alt="phone" /></span>
                <a href="tel:+ 971547 864 447">+ 971547 864 447</a>
              </div>
            </div>
          </div>
        </div>
