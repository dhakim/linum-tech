...
const ContactDetail = () => {
  return (
    <React.Fragment>
      <div className="container">
        <div className="contact-section">
          ...
          <div className="contact-information">
            <h3 data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">Contact Info</h3>

            <p className="address" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
            ...
            <div className="contact-info-wrapper">
              <div className="contact-info">
                <span className="icon" data-aos="fade-right" data-aos-delay="100" data-aos-duration="1000"><img src={emailBlueIcon} alt="email" /></span>
                <a href="mailto:info@linumtech.com" data-aos="fade-left" data-aos-delay="100" data-aos-duration="1000">info@linumtech.com</a>
              </div>

              <div className="contact-info">
                <span className="icon" data-aos="fade-right" data-aos-delay="100" data-aos-duration="1000"><img src={phoneBlueIcon} alt="phone" /></span>
                <a href="tel:+ 971547 864 447" data-aos="fade-left" data-aos-delay="100" data-aos-duration="1000">+ 971547 864 447</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="map" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
